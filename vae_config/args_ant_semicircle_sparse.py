...
def get_args(rest_args):
    ...
    parser.add_argument('--data-dir', default='data_semi_modified_init_state_dist')   # semi-modified Pinit - not on circle
    ...
    parser.add_argument('--save-dir-prefix', default='relabel_semi_modified_init_state_dist')
